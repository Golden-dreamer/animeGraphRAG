...
│        │                                                                    │
│        └── HTTP-эндпоинты: /refresh/{id}, /status, /failed, /failed/retry  │
│                                                                              │
...
processing.process_one(mal_id)
  ...
  │     ├── cached_get_html("https://myanimelist.net/anime/{id}/characters")
...
| `app.py` | FastAPI + фоновый вечный цикл scheduler'а | не содержит бизнес-логики парсинга напрямую |
