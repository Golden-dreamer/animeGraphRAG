...
## 2026-07-12 (v12) — CLARIFY, исправление LIMIT, sandbox-контейнер
...
- `sandbox/Dockerfile`, `docker-compose.yml`: новый сервис `sandbox` —
  изолированный контейнер для тестов (Python 3.12, curl, jq, pytest,
  neo4j driver). `restart: no`, монтирует backend/frontend/parsers.
