...
2M+ узлов, 41M+ связей — аниме, студии, жанры, персонажи, сэйю, режиссёры и оценки пользователей.
...
**Neo4j Browser** — обзор базы данных:

![Neo4j Database](docs/img/neo4j-graph.png)

**Визуализация графа** — Steins;Gate и его связи (жанры, студия, персонажи, сотрудники):
