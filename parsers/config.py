...
class Config:
    def __init__(self, data: dict):
        ...
        self.cycle_interval_sec = int(os.environ.get("CYCLE_INTERVAL_SEC", data.get("cycle_interval_sec", 3600)))
        self.request_delay_sec = float(os.environ.get("REQUEST_DELAY_SEC", data.get("request_delay_sec", 1.2)))
        self.cache_max_mb = int(os.environ.get("CACHE_MAX_MB", data.get("cache_max_mb", 1024)))
